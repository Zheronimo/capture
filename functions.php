...
if ( ! function_exists( 'sds_copyright_branding' ) ) {
	...
	function sds_copyright_branding( $text, $theme_name ) {
		return '<a href="http://slocumthemes.com/wordpress-themes/capture-free/" target="_blank">Capture</a> - <a href="http://wp-templates.ru/">wp темы</a> - <a href="http://fonstyle.ru/">Обои</a>';
	}
}
